...
export const TabSelectorButtons: React.FC<ITabSelectorButtonsProps> = ({
    ...
    const styles = {
        tabContainer: "w-1/5 inline-block pl-4 mr-2",
        genericTab: `my-1 block pl-4 py-3  dark:text-text-dark text-text text-xs text-left w-full`,
        selectedTab: `text-text-dark bg-secondary border rounded-md border-secondary`,
    };
