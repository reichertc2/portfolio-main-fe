    ...
    return (
        <section id="ContactSection" className="py-24 w-full pl-8">
            ...
            <div className="inline-block w-full text-center">
                ...
                <button
                    className="text-sky-200 p-2 inline-block border-2 border-solid border-sky-200 rounded-md opacity-70 hover:opacity-100">
                    <a
                        className=''
                ...
                <ul
                    className="text-3xl text-sky-300 p-3 content-center"
                >
                    <li
